...
/**
 * Detailed patient view - Shows comprehensive vitals, risk flags, and real-time status
 * Used for single-patient caregivers or drill-down from multi-patient dashboard
 */
export function PatientDetailScreen({ patientId, patientName }: PatientDetailScreenProps) {
  const { data: status, isLoading, error, refetch, isRefetching } = usePatientStatus(patientId);
  const { isConnected } = useWebSocket(patientId);
        ...
        <Card.Content>
          <View style={styles.headerRow}>
            <View style={styles.patientInfo}>
              <Text variant="headlineSmall">{patientName || status.patient.patientName}</Text>
